  ...
  return (
    <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
      ...
      <View style={{marginTop: 60, height: 90}}>
        <Text
          style={{fontSize: 30, color: theme.text, fontFamily: 'Inter-Bold'}}>
          {I18n.welcome}
        </Text>
      </View>
      ...
      <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
        <Text
          style={{fontSize: 18, color: theme.dark, fontFamily: 'Inter-Bold'}}>
          {I18n.configure_app}
        </Text>
        <View style={{flexDirection: 'row'}}>
          <TouchableOpacity onPress={() => setLanguageModal(true)}>
            <View
              ...
              <Text>Change Language ? Click here</Text>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => setThemeModal(true)}>
            <View
              ...
              <Text>Change Theme ? Click here</Text>
            </View>
          </TouchableOpacity>
        </View>
      </View>
